...
public class PerguntaTentativaDAOJDBC implements PerguntaTentativaDAO {
    ...
    public void insert(PerguntaTentativa obj) {
        ...
        try {
            st = conn.prepareStatement(
                    "INSERT INTO quiztentativa (id_usuario, id_pergunta, resposta_usuario, correta, data_tentativa) " +
                            "VALUES (?, ?, ?, ?, ?)",
    ...
    public List<PerguntaTentativa> findByUsuario(int idUsuario) {
        ...
        try {
            st = conn.prepareStatement(
                    "SELECT * FROM quiztentativa WHERE id_usuario = ? ORDER BY data_tentativa DESC"
            );
    ...
    public List<PerguntaTentativa> findByPergunta(int idPergunta) {
        ...
        try {
            st = conn.prepareStatement(
                    "SELECT * FROM quiztentativa WHERE id_pergunta = ? ORDER BY data_tentativa DESC"
            );
    ...
    public List<PerguntaTentativa> findAll() {
        ...
        try {
            st = conn.prepareStatement(
                    "SELECT * FROM quiztentativa ORDER BY data_tentativa DESC"
            );

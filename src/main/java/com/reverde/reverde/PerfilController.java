...
public class PerfilController implements Initializable {
    ...
    @FXML
    public void onEstatisticasClick(MouseEvent event) {
        appService.loadScene("estatisticas.fxml");
    }

    @FXML
    public void onSobreClick(MouseEvent event) {
        appService.loadScene("sobre_reverde.fxml");
    }

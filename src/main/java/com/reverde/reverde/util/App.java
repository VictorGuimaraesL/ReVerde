...
import com.reverde.reverde.ConverterPontosController;
import com.reverde.reverde.ConverterPontosSucessoController;
...
public class App extends Application implements AppService {
    ...
    @Override
    public void loadScene(String fxmlPath, Object dataToPass) {
        try {
            ...
            if (controller instanceof PerguntaValidacaoAcertoController) {
                ((PerguntaValidacaoAcertoController) controller).initData(dataToPass);
            } else if (controller instanceof ConverterPontosSucessoController) {
                ((ConverterPontosSucessoController) controller).initData(dataToPass);
            } else if (controller instanceof ConverterPontosController) {

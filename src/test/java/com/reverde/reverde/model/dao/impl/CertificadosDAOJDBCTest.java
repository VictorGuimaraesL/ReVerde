...
public class CertificadosDAOJDBCTest {
    ...
    void insert_ShouldInsertNewCertificadoAndAssignGeneratedId() throws SQLException {
        ...
        certificado.setCertificado((byte) 1);
        ...
        verify(mockPreparedStatement).setInt(1, certificado.getIdUsuario());
        verify(mockPreparedStatement).setInt(2, certificado.getIdPonto());
        verify(mockPreparedStatement).setString(3, certificado.getDescricao());
        verify(mockPreparedStatement).setByte(4, certificado.getCertificado());
        verify(mockPreparedStatement).setTimestamp(5, Timestamp.valueOf(certificado.getDataGeracao().atStartOfDay()));
    ...
    void findById_ShouldReturnCertificadoWhenFound() throws SQLException {
        ...
        when(mockResultSet.getByte("certificado")).thenReturn((byte) 1);
        when(mockResultSet.getTimestamp("data_geracao")).thenReturn(Timestamp.valueOf(LocalDate.of(2023, 1, 1).atStartOfDay()));
        ...
        assertEquals((byte) 1, certificado.getCertificado());
